...
main_page_content = '''
  <body>
    <!-- Trailer Video Modal -->
   <div class="modal" id="trailer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" position="fixed">
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
    <h4 class="modal-title" id="movieTitle">Movie Title</h4>
...
def create_movie_content(movies):
    # Create required html contents for the page
    movie_tiles = ''
    for movie in movies:
        movie_tiles += create_movie_tiles_content(movie)
    rendered_content = main_page_content.format(movie_tiles=movie_tiles)
    return rendered_content


def create_movie_tiles_content(movie):
...
def open_movies_page(movies):
    ...
    rendered_content = create_movie_content(movies)
    # Output the file
